class ItemsController < ApplicationController
  ...
  # GET /items/1.json
  def show
    @item_type = ItemType.includes(metadata_sets: [metadata_fields: [:metadata_values] ]).where(item_types: {id: @item.item_type_id} , metadata_values: {valuable_id: @item.id}).first
  end
