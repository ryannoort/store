class Collection < Entity
	...
	has_many :child_entities, class_name: "ParentEntity", foreign_key: :parent_entity_id
	has_many :children, -> {order 'parent_entities.order'}, :through => :child_entities, :source => :child_entity	
